...
{
    public class ItemCandleState : IItemState
    {
        ...
        //public Sprite sprite = SpriteFactory.Instance.GetSpriteData("Candle");

        public ItemCandleState(IItem item)
        {
            Item = item;
            Sprite = SpriteFactory.Instance.GetSpriteData("Candle");
        }
