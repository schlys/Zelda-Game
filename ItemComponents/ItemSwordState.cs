...
{
    public class ItemSwordState : IItemState
    {
        ...
        //public Sprite sprite = SpriteFactory.Instance.GetSpriteData("Sword");

        public ItemSwordState(IItem item)
        {
            Item = item;
            Sprite = SpriteFactory.Instance.GetSpriteData("Sword");
        }
